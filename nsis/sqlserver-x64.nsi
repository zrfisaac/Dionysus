...
; # - Geral
Name "Dionysus SQL Server Provider x64 0.0.1"
OutFile "..\out\sqlserver-x64.exe"
Unicode True
InstallDir "$SYSDIR"
...
Section SQLSERVER
	...
	File "..\sxs\amd64_microsoft-windows-m..server-provider-dll_31bf3856ad364e35_10.0.26100.1_none_61ecde29ee85d18d\sqloledb.dll"

	; File 64-bit
	SetOutPath "C:\windows\system32"
	File "..\x64\msdart.dll"
	File "..\x64\msdatsrc.tlb"
	File "..\x64\sqmapi.dll"
	...
	; Register 64-bit
	ExecWait '"C:\Windows\system32\regsvr32.exe" /s "Windows\system32\msdart.dll"'
	ExecWait '"C:\Windows\system32\regsvr32.exe" /s "C:\Windows\system32\sqloledb.dll"'
	ExecWait '"C:\Windows\system32\regsvr32.exe" /s "Windows\system32\sqlsrv32.dll"'

	; Register 32-bit
	ExecWait '"C:\Windows\syswow64\regsvr32.exe" /s "C:\Windows\syswow64\msdart.dll"'
